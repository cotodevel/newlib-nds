...
#ifndef __main_ndstool
#define __main_ndstool
...
extern void Help(char *specificoption);
extern void Title();
extern unsigned short CalcHeaderCRC(Header& header);
extern unsigned short CalcLogoCRC(Header& header);
extern void FixHeaderCRC(char *ndsfilename);
