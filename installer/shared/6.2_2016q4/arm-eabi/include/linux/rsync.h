...
#define MAX_BLOCK_SIZE ((sint32)1 << 17)

/* For compatibility with older rsyncs */
#define OLD_MAX_BLOCK_SIZE ((sint32)1 << 29)
...
struct sum_buf {
	...
	sint32 len;		/**< length of chunk of file */
	uint32 sum1;	        /**< simple checksum */
	sint32 chain;		/**< next hash-table collision */
...
struct sum_struct {
	...
	sint32 count;		/**< how many chunks */
	sint32 blength;		/**< block_length */
	sint32 remainder;	/**< flength % block_length */
...
struct map_struct {
	...
	sint32 p_size;		/* Largest window size we allocated	*/
	sint32 p_len;		/* Latest (rounded) window size		*/
	sint32 def_window_size;	/* Default window size			*/
