...
/* _IO_pos_BAD is an sint64 value indicating error, unknown, or EOF.  */
#define _IO_pos_BAD ((sint64) -1)

/* _IO_pos_adjust adjusts an sint64 by some number of bytes.  */
#define _IO_pos_adjust(pos, delta) ((pos) += (delta))

/* _IO_pos_0 is an sint64 value indicating beginning of file.  */
#define _IO_pos_0 ((sint64) 0)
...
extern int _IO_vfprintf (FILE *__restrict, const char *__restrict,
			 __gnuc_va_list);
extern sint32 _IO_padn (FILE *, int, sint32);
extern size_t _IO_sgetn (FILE *, void *, size_t);

extern sint64 _IO_seekoff (FILE *, sint64, int, int);
extern sint64 _IO_seekpos (FILE *, sint64, int);
...
extern int _IO_vfwprintf (FILE *__restrict, const wchar_t *__restrict,
			  __gnuc_va_list);
extern sint32 _IO_wpadn (FILE *, wint_t, sint32);
